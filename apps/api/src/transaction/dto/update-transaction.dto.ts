...
/**
 * PATCH /transactions/:id body. Phase 6, iterations 6.7 + 6.8.
 *
 ...
 * equivalent to `DELETE ?scope=all` and hard-deletes the transaction when it
...
export class UpdateTransactionDto {
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Change the transaction type (e.g. RECURRING → ONE_TIME). Transitioning out of RECURRING ' +
