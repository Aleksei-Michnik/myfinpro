...
test.describe('Legal Pages', () => {
  ...
  test('Hebrew Terms page renders RTL heading', async ({ page }) => {
    await page.goto('/he/legal/terms');
    const heading = page.getByRole('heading', { name: 'תנאי שימוש' });
    await expect(heading).toBeVisible();
  });

  test('Hebrew Privacy page renders RTL heading', async ({ page }) => {
    await page.goto('/he/legal/privacy');
