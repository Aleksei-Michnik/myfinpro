...
test.describe('Footer', () => {
  ...
  test('footer contains Terms of Use link with correct text and href', async ({ page }) => {
    const termsLink = page.locator('footer a[href="/en/legal/terms"]');
  ...
  test('footer contains Privacy Policy link with correct text and href', async ({ page }) => {
    const privacyLink = page.locator('footer a[href="/en/legal/privacy"]');
  ...
  test('footer contains Help link with correct text and href', async ({ page }) => {
    const helpLink = page.locator('footer a[href="/en/help"]');
  ...
  test('footer is visible on Hebrew locale', async ({ page }) => {
    await page.goto('/he');
    const footer = page.locator('footer');
    await expect(footer).toBeVisible();
