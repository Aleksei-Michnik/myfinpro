        ...
        <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
          ...
          <dl className="space-y-3">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3 dark:border-gray-700">
              ...
              <dd className="text-sm text-gray-900 dark:text-gray-100" data-testid="user-email">
                {user?.email}
              </dd>
            </div>
            <div className="flex items-center justify-between border-b border-gray-100 pb-3 dark:border-gray-700">
              <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('name')}</dt>
              <dd className="text-sm text-gray-900 dark:text-gray-100" data-testid="user-name">
                {user?.name}
              </dd>
            </div>
            <div className="flex items-center justify-between">
              ...
              <dd className="text-sm text-gray-900 dark:text-gray-100" data-testid="user-provider">
