...
export default async function PrivacyPage() {
  ...
  return (
    <article className="max-w-3xl mx-auto space-y-8 leading-relaxed text-gray-800 dark:text-gray-200">
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">{t('privacy.infoCollect.title')}</h2>
        <p>{t('privacy.infoCollect.content')}</p>
      </section>

      <section>
        <h2 className="text-xl font-semibold mb-2">{t('privacy.howWeUse.title')}</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">{t('privacy.cookies.title')}</h2>
        <p>{t('privacy.cookies.content')}</p>
      </section>

      <section>
        <h2 className="text-xl font-semibold mb-2">{t('privacy.retention.title')}</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">{t('privacy.children.title')}</h2>
